...
if (textItems.length > 0) {
  ...
  const outputPath = '/home/tmp/Documents/shajare-back/data/text-blocks-with-children.json';
  ...
  const csvPath = '/home/tmp/Documents/shajare-back/data/text-blocks-with-children.csv';
  fs.writeFileSync(csvPath, csvRows.join('\n'), 'utf8');
  console.log(`\nCSV file saved to: ${csvPath}`);
  
  // Create a simple text file with all information including children
  const textOutputPath = '/home/tmp/Documents/shajare-back/data/text-blocks-with-children.txt';
